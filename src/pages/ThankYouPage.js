...
// /* Hero */
// const Row = styled.div`flex`;
// const NavRow = styled.div`flex flex-col lg:flex-row items-center justify-between`;
// const NavLink = styled.a`mt-4 lg:mt-0 transition duration-300 font-medium pb-1 border-b-2 lg:mr-12 last:mr-0 text-gray-700 border-gray-400 hocus:border-gray-700 `;
// const PrimaryNavLink = styled.div`text-gray-100 bg-primary-500 px-6 py-3 border-none rounded hocus:bg-primary-900 focus:shadow-outline`;
// const HeroRow = styled.div`max-w-xl flex-col justify-between items-center py-20 lg:py-24 mx-auto`;

// const Heading = styled.div`text-center text-primary-900 leading-snug`;
// const Description = styled.div`mt-4 text-center lg:text-base text-gray-700 max-w-lg mx-auto lg:mx-0`;
...
//       <Container className="mx-5 mt-5 pt-5 px-5">
//         <Content2Xl>
//           <NavRow>
//             <LogoLink href="/">
//               <img src={logo} alt="" />
